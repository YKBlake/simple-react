...
<ul>
  ...
  <li>Our backend and frontend can operate on the same port (so we don't have to label our REST controller with @CrossOrigin; If you want to be able to use the Vite dev server, use the annotation <b>@CrossOrigin(origins={"http://localhost:5173"})</b> above the necessary controllers)</li>
</ul>
